	...
	k.o = function () {
		...
		this.run = function () {
			...
			this.$c = $('<canvas width="' +
				...
				(this.o.height+this.o.xtraHeight) + 'px" style="position: absolute;"></canvas>');
		...
		this._draw = function () {
			...
			c.width = s.o.width;
			c.height = s.o.height+s.o.xtraHeight;
			s.g = c.getContext('2d');
		...
		return this.each(
			function () {
				...
				this.banner = function(message) {
					var c = d.c2;
					c.clearRect(0, 0, d.o.width, d.o.height);
					c.fillStyle = d.o.fgColor;
					c.strokeStyle = d.o.fgColor;
					c.font = d.i.css("font");
					c.font = 'bold '+(d.o.width / 7) +'px Arial';
					c.textAlign = 'center';
					c.textBaseline = 'bottom';
